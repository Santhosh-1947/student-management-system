...
public class StudentController {
    ...
    @PostMapping("/login")
    public ResponseEntity<String> login(@RequestBody Student loginAuthen) {
        // Authenticate user
        Student permittedStudent = studentService.login(loginAuthen.getUserName(), loginAuthen.getPassword());
